...
\subsection{Implementação dos \textit{Tetris}}
    ...
    há 7 \textit{tetraminós} que o jogador pode controlar, são eles:

    \FloatBarrier
\begin{figure}[!htbp]
	\centering
	\caption{Os 7 \textit{tetraminós}}
	\includegraphics[scale=1.1]{imagens/tetraminoes.png}
...
também será avaliado qual o consumo de CPU em cada um dos jogos executados, Consumo de memória RAM e perfomance em geral.
