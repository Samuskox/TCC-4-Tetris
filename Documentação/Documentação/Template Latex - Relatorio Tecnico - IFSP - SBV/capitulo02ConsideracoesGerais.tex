...
o desenvolvimento na \textit{Godot Engine} é baseado em classes de objetos chamados nós (\text{nodes}) \cite{salmela2022_godot}. 
...
nós são organizados em uma cena de acordo como o desenvolvedor quiser para comportamentos mais complexos \cite{salmela2022_godot}.
