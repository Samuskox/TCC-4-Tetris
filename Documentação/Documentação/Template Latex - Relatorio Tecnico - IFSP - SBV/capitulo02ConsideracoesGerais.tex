...
\david{tradicionais fica melhor mesmo}
...
\david[inline]{não é assim que referencia figura}

	Abaixo está a imagem de um baralho clássico que está presente em vários jogos de cartas:
    
\david[inline]{é assim. arrume TODOS}
...
\david[inline]{use a macro url para definir as urls das fontes. fiz no exemplo abaixo. ajuste o restante.}
...
\FloatBarrier
	...
	Um exemplo de um jogo de tabuleiro, o xadrez abaixo:
...
\FloatBarrier
	...
	Abaixo está um exemplo de um jogo atlético, o basquete:
...
\FloatBarrier
	...
	Um clássico dos jogos de FPS é mostrado abaixo:
...
Um bom exemplo de um jogo de luta chamado "\textit{Street Figher}"é mostrado abaixo
...
gestão urbana, como as funções de um prefeito e os processos de construção e organização de uma cidade, é mostrado uma imagem do jogo abaixo:
...
é possível encapsular dados dentro de um bloco e criar métodos de manipulação desses dados. Um exemplo de encapsulamento é mostrado na imagem abaixo: 
...
apenas uma vez, pois os \textit{bytecode} são gerados dentro do arquivo classe e podem ser executados em qualquer plataforma de hardware e software \cite{indrusiak_java, deitel2016java}.
