...
diversas metodologias de análise de jogos, sendo três os principais
elementos:
...
\subsection{Tipos de Jogos não Digitais}

\begin{itemize}
	\item \textbf{Jogos de Cartas:} A categoria de jogos de cartas são aquelas no qual há a interação entre os jogadores através de um baralho de cartas,
...
\FloatBarrier
	...
	\item \textbf{Jogos de Tabuleiro:} Os jogos de tabuleiro são os que representam fisicamente um plano jogavel e representam também a divisória de setores
