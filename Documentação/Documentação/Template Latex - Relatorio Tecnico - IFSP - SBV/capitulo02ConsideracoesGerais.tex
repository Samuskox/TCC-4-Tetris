...
\texttt{pygame.init()} & Importa e inicializa todos os módulos da biblioteca. \\ \hline
\texttt{pygame.display} & Vários métodos para configurar a janela ou a tela \\ \hline
\texttt{pygame.event.get()} & Detecta se algum evento ocorreu, por exemplo: jogador apertou uma tecla. \\ \hline
\texttt{pygame.draw} & Conjunto de métodos usados para desenhar formas e geometria. \\ \hline
\texttt{pygame.display.flip()} & Atualiza a tela inteira. \\ \hline
\texttt{pygame.quit()} & Fecha a aplicação. \\ \hline
\end{tabular}
\end{table}
