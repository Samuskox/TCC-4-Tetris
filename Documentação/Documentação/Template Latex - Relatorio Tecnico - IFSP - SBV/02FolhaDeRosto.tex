...
\begin{table}[!htbp]
	...
	\begin{tabular}{| >{\centering}m{2in} | >{\centering}m{2in} | >{\centering\arraybackslash}m{2in} | }
		\hline
		\specialcell[t]{INSTITUTO FEDERAL DE\\EDUCAÇÃO, CIÊNCIA E\\TECNOLOGIA DE SÃO\\PAULO - CÂMPUS SÃO\\JOÃO DA BOA VISTA} & Junho & 2026 \\
		\hline
		...
		\multicolumn{2}{|l|}{\specialcell{Palavras-chave:\\desenvolvimento de jogos; paradigmas; comparativo; \\tetris; arquitetura;java; C++; python; godot;}} & \the\numexpr \getpagerefnumber{LastPage} - 1 \relax \  páginas \\
		\hline
	\end{tabular}
\end{table}
\FloatBarrier