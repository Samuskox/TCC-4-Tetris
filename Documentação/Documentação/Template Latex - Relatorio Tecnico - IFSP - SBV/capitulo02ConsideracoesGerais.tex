...
Java é uma linguagem de programação que surgiu na década de 90, como uma necessidade para tráfegar dados na web, a linguagem é baseada no paradigma de orienteção à objeto, 
...
A linguagem de programação C++, se originou a partir da linguagem de programação C, foi criado para abstrair dados, suportar a programação orientada a objeto e suprir uma 
demanda de programas de softwares que ocorreu na década de 1980 \cite{deitel2005cpp}.
