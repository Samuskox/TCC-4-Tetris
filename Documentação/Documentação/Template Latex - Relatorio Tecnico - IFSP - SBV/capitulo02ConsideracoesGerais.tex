...
Jogos de Ação-Aventura se definem pela combinação de elementos de ação e de aventura, são bem similares aos ambos os gêneros,
 geralmente oferecem ao jogador uma narrativa construida ao longo de elementos de ação,
  ...
  Um exemplo de jogo de gênero de ação-aventura é mostrado abaixo:
...
Um exemplo de um jogo de RPG é mostrado abaixo:
...
Um exemplo de um jogo de estratégia é representado na imagem abaixo:
