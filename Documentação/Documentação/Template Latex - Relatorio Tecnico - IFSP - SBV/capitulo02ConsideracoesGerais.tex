...
\section{Tipos de Jogos não Digitais}
...
\section{Tipos de Jogos Eletrônicos}
	Nesta subseção iremos discorrer a definição dos tipos, genêros e seus subgêneros de jogos eletrônicos.
	...
	\subsubsection{FPS\textit{First Person Shooter}}

	 Um FPS se defini através do jogador costantemente
